...
$arResult['HELPER'] = $helper = new \Bitrix\Tasks\UI\Component\TemplateHelper(null, $this, [
	'RELATION' => [
		'tasks_itemsetpicker',
		'tasks_util',
		'tasks_util_query',
...
$this->__component->tryParseEnumerationParameter($arParams['DISPLAY'], ['inline', 'block'], 'block');
