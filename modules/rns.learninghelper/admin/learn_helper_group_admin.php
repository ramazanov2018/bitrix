...
$arFilter = array(
	...
	'!COURSE_LESSON_ID' => \LearningHelper\WaitList::COURSE_WAITLIST,
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddField("ID", '<a href="/bitrix/admin/learn_helper_group_edit.php?ID='.$f_ID.'&lang='.LANGUAGE_ID.'" title="'.GetMessage("MAIN_ADMIN_MENU_EDIT").'">'.$f_ID.'</a>');
	...
	$arActions[] = array(
		...
		"ACTION"  => $lAdmin->ActionRedirect("learn_helper_group_edit.php?lang=" . LANG . "&ID=" . $f_ID . GetFilterParams("filter_"))
	);

    $arActions[] = array(
		"ICON"    => "import",
		"DEFAULT" => "Y",
		"TEXT"    => GetMessage("MAIN_ADMIN_MENU_WAITLIST_IMPORT"),
		"ACTION"  => $lAdmin->ActionRedirect("learn_helper_group_edit.php?lang=" . LANG . "&IMPORT=WAITLIST&ID=" . $f_ID . GetFilterParams("filter_"))
	);
...
$lAdmin->AddAdminContextMenu(array(
	array(
		...
		'LINK'  => 'learn_helper_group_edit.php?lang=' . LANG . GetFilterParams('filter_'),
