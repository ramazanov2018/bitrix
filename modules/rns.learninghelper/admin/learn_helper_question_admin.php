...
foreach ($arQuestions as $arRes)
{
	...
	$editUrl = "learn_helper_question_edit.php?lang=".LANG.'&LESSON_PATH='.$uriLessonPath
...
$arContextPopup = Array(
	Array(
		...
		"LINK" => "learn_helper_question_edit.php?lang="
			. LANG
			. '&LESSON_PATH=' . $uriLessonPath
			. "&QUESTION_TYPE=S" . GetFilterParams("filter_", false)
			. $str_from
		//"window.location='learn_helper_question_edit.php?lang=".LANG."&COURSE_ID=".$COURSE_ID."QUESTION_TYPE=S".GetFilterParams("filter_", false)."'",
	...
	Array(
		...
		"LINK" =>
		"learn_helper_question_edit.php?lang="
			. LANG
			. '&LESSON_PATH=' . $uriLessonPath
			. "&QUESTION_TYPE=M"
		...
		//"window.location='learn_helper_question_edit.php?lang=".LANG."&COURSE_ID=".$COURSE_ID."QUESTION_TYPE=M".GetFilterParams("filter_", false)."'",
	),
	Array(
		"TEXT" => GetMessage('LEARNING_SORTING'),
		//"ICON" => "learning-question-s",
		"LINK" => "learn_helper_question_edit.php?lang=" . LANG
			. '&LESSON_PATH=' . $uriLessonPath
			. "&QUESTION_TYPE=R"
			. GetFilterParams("filter_", false)
			. $str_from
    ...
    Array(
		...
		"learn_helper_question_edit.php?lang=" . LANG
			. '&LESSON_PATH=' . $uriLessonPath
			. "&QUESTION_TYPE=".ComparisonAnswer::CUESTION_TYPE
			. GetFilterParams("filter_", false)
			. $str_from
...
$filter->Buttons(array(
	"table_id" => $sTableID,
	"url"      => "learn_helper_question_admin.php?lang=" . LANG . "&LESSON_PATH=" . $uriLessonPath,
	"form"     => "find_form"));
$filter->End();
?>
</form>
