	...
	if ( ! $was_errors )
	{
		...
		if ($apply == '')
		{
			...
			else
			{
				...
				LocalRedirect(
					"/bitrix/admin/learn_helper_unilesson_admin.php?lang=".LANG.
		...
		LocalRedirect("/bitrix/admin/learn_helper_unilesson_edit.php?lang=" . LANG
...
if (isset($g_learn_parentLessonPath))
{
	$aContext = array(
		array(
			...
			"LINK"  => "learn_helper_unilesson_admin.php?lang=" . LANG . "&LESSON_PATH=" . urlencode($g_learn_parentLessonPath) . GetFilterParams("filter_"),
...
else
{
	...
	$aContext = array(
		array(
			...
			'LINK'  => 'learn_helper_unilesson_admin.php?lang=' . LANG
				. '&set_filter=Y'
...
if ($LESSON_ID > 0)
{
	$aContext[] = array(
		...
		"LINK"	=> "javascript:if(confirm('"
			...
			. "'))window.location='learn_helper_unilesson_admin.php?lang=" . LANG
			...
			if ($bContentReadOnly)
			{
				...
				<div id="learn_unilesson_edit_detail_text_div">
					<script type="text/javascript">
						...
						document.getElementById('learn_helper_unilesson_edit_detail_text_div').appendChild(iframe);
						var idoc = iframe.contentWindow.document;
...
$tabControl->Buttons(
	array(
		...
		"back_url" => "/bitrix/admin/learn_helper_unilesson_admin.php?lang=". LANG
			. $uriParentLessonPath
			. GetFilterParams("filter_", false)
		)
	);
