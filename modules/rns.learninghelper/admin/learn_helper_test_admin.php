...
if ($lessonId)
    $arFilter["QUESTIONS_FROM_ID"] = $lessonId;
...
while($arRes = $rsData->NavNext(true, "f_"))
{
    ...
    $editUrl = "learn_helper_test_edit.php?lang=" . LANG
        . "&COURSE_ID=" . $COURSE_ID
...
?>
    ...
    <form method="get" action="learn_helper_test_admin.php?lang=<?=LANG?>&COURSE_ID=<?=$COURSE_ID?>&PARENT_LESSON_ID=<?php
