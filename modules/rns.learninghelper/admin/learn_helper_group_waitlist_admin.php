...
$sTableID = "t_learning_helper_group_admin";
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddField("ID", '<a href="/bitrix/admin/learn_helper_group_waitlist_edit.php?ID='.$f_ID.'&lang='.LANGUAGE_ID.'" title="'.GetMessage("MAIN_ADMIN_MENU_EDIT").'">'.$f_ID.'</a>');
	...
	$arActions[] = array(
		...
		"ACTION"  => $lAdmin->ActionRedirect("learn_helper_group_waitlist_edit.php?lang=" . LANG . "&ID=" . $f_ID . GetFilterParams("filter_"))
	);
...
if (!$isWaitList){
    $lAdmin->AddAdminContextMenu(array(
        array(
            ...
            'LINK'  => 'learn_helper_group_waitlist_edit.php?lang=' . LANG . GetFilterParams('filter_'),
