                        ...
                        case "USER_TYPE":
                            for ($i = 0; $i < $inputNum; $i++)
                            {
                                ...
                                else
                                {
                                 ...
                                 if($arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'REGISTRY_DATE_TIME'){?>
                                     <input style="display: inline" id="inputRegisterDate" type="text" name="PROPERTY[<?= $propertyID ?>][<?= $i ?>][VALUE]" value="<?=$value?>" readonly>
                                     <button id="dateRegisterBtn" type="button" class="btn btn-link">Расписание</button>
                                     <?continue?>
                                <?}
...
<!--<div class="col-margin-top">
    <div class="schedule">
        <div id="schedule_result" class="schedule-header-wrapper white-box sticky clearfix">
        </div>
    </div>
</div>-->
<div id="modal_result">
