...
if (typeof(BX.RegisterDate) === "undefined")
{
    ...
    BX.RegisterDate = function ()
    {
        ...
        this.inputRegisterTime = BX('inputRegisterTime');
        this.inputRegisterDateTime = BX('inputRegisterDateTime');
    ...
    BX.RegisterDate.prototype =
        {
            ...
            _EventsRegister: function(){
                ...
                $(document).on('click', 'a[data-type=registry]', function (e) {
                    ...
                    var timeRegistry = $(this).attr('data-time');

                    self.inputRegisterDateTime.value = dateRegistry +" "+ timeRegistry + ":00";
                    self.inputRegisterDate.value = dateRegistry;
                    self.inputRegisterTime.value = timeRegistry;
