...
<h1 class="mb-26">Отзывы</h1>
<? if (strlen($arResult["MESSAGE"]) > 0): ?>
    <?= ShowNote($arResult["MESSAGE"]) ?>
<? endif ?>
<p class="mb10">
    <?=GetMessage("FORM_ADD_title_desc")?>
</p>
<a id="ReviewFormOpen" class="btn venobox" data-vbtype="inline" data-maxwidth="400px" href="#takeReview"><?=GetMessage("FORM_ADD_btn_add")?></a>

<div  style="display: none;" id="takeReview">
    <div class="modalWindow">
        <h1 class="mb10"><?=GetMessage("page_title")?></h1>
        <?$isError = "N"?>
                                ...
                                case "N":
                                    for ($i = 0; $i < $inputNum; $i++)
                                    {
                                        ...
                                        if($arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'PERSONAL_PHONE'){
                                            $type = 'phone';
                                        }elseif($arResult["PROPERTY_LIST_FULL"][$propertyID]['CODE'] == 'PERSONAL_EMAIL'){
                                            $type = 'email';
                                        }else{
                                            $type = 'text';
                                        }
...
<script>
    window.onload = function() {
        <?if($isError == "Y"){?>
            document.getElementById('ReviewFormOpen').click();
        <?}?>
