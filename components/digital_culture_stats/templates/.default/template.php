...
\Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/build/css/statisticsMain.css", true);
...
?>
<form class="container statisticsMain" action="#"  method="get">
    <h3 class="statisticsMain__title"><?=Loc::getMessage("DCD_PAGE_TITLE")?></h3>
    <div class="statisticsMain__filter datepicker">
        <label class="statisticsMain__label datepicker__wrap">
            <input class="statisticsMain__input datepicker__date" id="dateStart" name="date_from" readonly value="<?=$arResult['REQUEST_PARAM']['date_from']?>">
        </label>
        <label class="statisticsMain__label datepicker__wrap">
            <input class="statisticsMain__input datepicker__date" id="dateEnd" name="date_to" readonly value="<?=$arResult['REQUEST_PARAM']['date_to']?>">
        </label>
        <button class="statisticsMain__filterButton btn-primary" id="showDocFilter" type="submit" name="date_filter" value="Y"><?=Loc::getMessage("DCD_FILTER_BTN")?></button>
    </div>
    <div class="statisticsMain__view">
